...
export function buildFeaturesPage(settings) {
    ...
    addSwitch(providers, settings, 'enable-calculator',
        'Calculator', 'Evaluate math including 50%, sqrt, asin, log2, sin 90, 1+2=, 1+2=3, 1 000 + 2, 5!, e+1, =e, 2pi^2, 5 squared, 2 to the power of 8, 2 to the 8th, 2 to the eighth, 2 plus 2, two plus two, 2 add 3, 8 subtract 3, and 8 over 2 and copy the result with Enter');
