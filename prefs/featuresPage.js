...
export function buildFeaturesPage(settings) {
    ...
    addSwitch(providers, settings, 'enable-calculator',
        'Calculator', 'Evaluate math including 50%, sqrt, asin, log2, sin 90, 1+2=, 1 000 + 2, 5!, e+1, =e, 2pi^2, 2π, and 5² and copy the result with Enter');
    ...
    addSwitch(providers, settings, 'enable-window-search',
        'Open windows', 'Switch by title, class, or workspace 2. Type close firefox, kill firefox, or force quit firefox');
