...
export function buildFeaturesPage(settings) {
    ...
    addSwitch(providers, settings, 'enable-app-search',
        'Applications', 'Installed apps ranked by match quality and usage. open firefox, open up firefox, start up firefox, fire up firefox, execute firefox, chrome browser, find firefox, search for firefox, and find windows firefox still find the app. open source stays a name');
