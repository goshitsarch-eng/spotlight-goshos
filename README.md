...
- The on-screen keyboard parks `keyboardBox` at the monitor bottom and slides the keys with the child's `translation_y`. The work area follows that child so the list is not covered.
