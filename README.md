...
- GTK bookmark lines that are bare filesystem paths or `~/…` become `file://` URIs. Existing `file://` lines with spaces are re-encoded before launch. `javascript:` bookmarks are ignored.
