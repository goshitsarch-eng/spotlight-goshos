...
8. **Color** — A hash hex such as `#f00`, `#ff0000`, `#f00f`, or `#ff000080`, or `rgb(255, 0, 0)` / `rgb(255 0 0)` / `rgb(100%, 0%, 0%)` / `hsl(0, 100%, 50%)` / `hsl(0deg 100% 50%)` / `hwb(0 0% 0%)` / `hwb(0deg, 0%, 0%)`, copies the 6-digit color. `# wifi` is still the Settings prefix; `#ff0000` is not.
