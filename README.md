...
8. **Color** — A hash hex such as `#f00`, `#ff0000`, `#f00f`, or `#ff000080`, or `rgb(255, 0, 0)` / `hsl(0, 100%, 50%)`, copies the 6-digit color. `# wifi` is still the Settings prefix; `#ff0000` is not.
