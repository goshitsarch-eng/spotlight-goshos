...
keywords match as prefixes or word-prefixes not mid-string so row does not hit browser and een does not hit lock screen titles can still substring-match at three letters
