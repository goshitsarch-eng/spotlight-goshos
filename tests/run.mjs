...
assertEq(focusLossAction(false, false, false, false), 'ignore', 'gnome 48 null focus');
assertEq(focusLossAction(true, true, false, false), 'ignore', 'stage focus is not alt-tab');
