...
import {canOpenPopup, shouldCloseOnToggle, shouldCloseOnSession} from '../popupGate.js';
...
import {shouldOfferApp, hasParentalGiveUp, markParentalGiveUp, PARENTAL_GIVE_UP_MS} from '../appReady.js';
